      ...
      <section className="relative overflow-hidden border-b border-white/5">
        ...
        <div className="relative mx-auto max-w-4xl px-5 py-20 text-center lg:px-8">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-base leading-7 text-zinc-400 sm:text-lg">
            Kobas Tech est votre partenaire des solutions digitales : produits
            numériques, logiciels, accessoires et services technologiques
            réunis dans une boutique pensée pour vous.
          </p>
        </div>
      </section>
