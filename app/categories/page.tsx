...
export const metadata: Metadata = {
  title: "Catégories | Kobas Tech",
  description:
    "Explorez les catégories de produits numériques et technologiques disponibles sur Kobas Tech au Bénin : gaming, logiciels, informatique et téléphones.",
  keywords: [
    "Kobas Tech",
    "catégories Kobas Tech",
    "technologie Bénin",
    "produits numériques",
    "gaming Bénin",
    "logiciels Bénin",
  ...
  openGraph: {
    title: "Catégories | Kobas Tech",
    description:
      "Découvrez les catégories de produits numériques et technologiques disponibles chez Kobas Tech.",
          ...
          {categories.length === 0 ? (
            <div className="mt-12 rounded-3xl border border-white/10 bg-white/[0.025] px-6 py-20 text-center">
              ...
              <p className="mx-auto mt-3 max-w-md text-sm leading-6 text-zinc-500">
                Les catégories apparaîtront ici dès qu&apos;elles seront
                ajoutées.
              </p>
            </div>
          ) : (
