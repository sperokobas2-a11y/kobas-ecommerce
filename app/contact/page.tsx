        ...
        <div className="grid gap-10 lg:grid-cols-[380px_1fr]">
          ...
          <div className="space-y-4">
            <div className="rounded-2xl border border-white/8 bg-white/[0.025] p-6">
              ...
              <h3 className="mt-5 font-semibold">WhatsApp</h3>
            ...
            <div className="rounded-2xl border border-white/8 bg-white/[0.025] p-6">
              ...
              <h3 className="mt-5 font-semibold">E-mail</h3>
            ...
            <div className="rounded-2xl border border-white/8 bg-white/[0.025] p-6">
              ...
              <h3 className="mt-5 font-semibold">Localisation</h3>
            ...
            <div className="rounded-2xl border border-white/8 bg-white/[0.025] p-6">
              ...
              <h3 className="mt-5 font-semibold">Disponibilité</h3>
